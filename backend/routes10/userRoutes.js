...
import { adminDashboardCount, deleteUserrr, findUserAll, findUserById, findUserByIdAndUpdate, logIn, signUp } from "../controller10/control.js"
...
userRouter.get("/adminDashboardCount",adminDashboardCount)
