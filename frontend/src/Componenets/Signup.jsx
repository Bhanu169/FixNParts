...
//     try {
//       e.preventDefault()
//       const log = await axios.post(`https://fixnparts.onrender.com/user/signUp`, formData)
//       console.log(log)
          ...
          <form onChange={handleChange} onSubmit={handleSubmit}>
            ...
            <div className="text-center mt-3">
              <p className="text-muted">
                Are you an admin? <a href="/AdminLogin" className="text-decoration-none fw-bold text-primary">Login here</a>
              </p>
            </div>
