            ...
            <div className="container-xxl py-5">
                <div className="container">
                    <div className="text-center wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <h1 className="mb-5">Reach Out With Any Queries</h1>
                    </div>
                    <div className="row g-4">
                        ...
                        <div className="col-md-6">
                            <div className="wow fadeInUp" data-wow-delay="0.2s">
                                <p className="mb-4">
                                    If you have questions about our mechanic booking process, part delivery, admin dashboard, or want help navigating the app — we’re here to support you. Whether you're a customer or admin, just drop us a message and we’ll respond quickly with the information you need.
                                </p>
                                <form>
